package com.perumalraj.myapp.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.perumalraj.myapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.perumalraj.myapp.security.DomainUserDetailsService", "createSpringSecurityUser");
