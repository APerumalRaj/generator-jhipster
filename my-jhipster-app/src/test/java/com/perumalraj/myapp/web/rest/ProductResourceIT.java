...
import static com.perumalraj.myapp.domain.ProductAsserts.*;
import static com.perumalraj.myapp.web.rest.TestUtil.createUpdateProxyForBean;
...
class ProductResourceIT {
    ...
    public static Product createEntity() {
        return new Product().sample(DEFAULT_SAMPLE).name(DEFAULT_NAME).price(DEFAULT_PRICE).date(DEFAULT_DATE);
    }
    ...
    public static Product createUpdatedEntity() {
        return new Product().sample(UPDATED_SAMPLE).name(UPDATED_NAME).price(UPDATED_PRICE).date(UPDATED_DATE);
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.sample(UPDATED_SAMPLE).name(UPDATED_NAME).price(UPDATED_PRICE).date(UPDATED_DATE);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.sample(UPDATED_SAMPLE).date(UPDATED_DATE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.sample(UPDATED_SAMPLE).name(UPDATED_NAME).price(UPDATED_PRICE).date(UPDATED_DATE);
